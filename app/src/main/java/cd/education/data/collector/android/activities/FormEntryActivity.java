...
package cd.education.data.collector.android.activities;
...
import cd.education.data.collector.android.exception.JavaRosaException;
import cd.education.data.collector.android.listeners.AdvanceToNextListener;
import cd.education.data.collector.android.listeners.FormLoaderListener;
import cd.education.data.collector.android.listeners.FormSavedListener;
import cd.education.data.collector.android.listeners.SavePointListener;
import cd.education.data.collector.android.logic.FormController;
import cd.education.data.collector.android.preferences.AdminPreferencesActivity;
import cd.education.data.collector.android.preferences.PreferencesActivity;
import cd.education.data.collector.android.provider.FormsProviderAPI;
import cd.education.data.collector.android.provider.InstanceProviderAPI;
import cd.education.data.collector.android.tasks.FormLoaderTask;
import cd.education.data.collector.android.tasks.SavePointTask;
import cd.education.data.collector.android.tasks.SaveResult;
import cd.education.data.collector.android.tasks.SaveToDiskTask;
import cd.education.data.collector.android.utilities.CompatibilityUtils;
import cd.education.data.collector.android.utilities.FileUtils;
import cd.education.data.collector.android.utilities.MediaUtils;
import cd.education.data.collector.android.views.ODKView;
import cd.education.data.collector.android.widgets.QuestionWidget;
...
public class FormEntryActivity extends Activity implements AnimationListener,
	...
	private void sendSavedBroadcast() {
		Intent i = new Intent();
		i.setAction("cd.education.data.collector.android.FormSaved");
