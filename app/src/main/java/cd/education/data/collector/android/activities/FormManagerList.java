...
import cd.education.data.collector.android.listeners.DeleteFormsListener;
import cd.education.data.collector.android.listeners.DiskSyncListener;
import cd.education.data.collector.android.provider.FormsProviderAPI.FormsColumns;
import cd.education.data.collector.android.tasks.DeleteFormsTask;
import cd.education.data.collector.android.tasks.DiskSyncTask;
import cd.education.data.collector.android.utilities.VersionHidingCursorAdapter;
