...
package cd.education.data.collector.android.views;
...
import cd.education.data.collector.android.activities.FormEntryActivity;
import cd.education.data.collector.android.application.Collect;
import cd.education.data.collector.android.exception.ExternalParamsException;
import cd.education.data.collector.android.exception.JavaRosaException;
import cd.education.data.collector.android.external.ExternalAppsUtils;
import cd.education.data.collector.android.logic.FormController;
import cd.education.data.collector.android.widgets.IBinaryWidget;
import cd.education.data.collector.android.widgets.QuestionWidget;
import cd.education.data.collector.android.widgets.WidgetFactory;
